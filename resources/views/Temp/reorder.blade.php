                        ...
                        <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first" data-wizard-clickable="false">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12">
                                    ...
                                    <!--begin::Wizard Form-->
                                    <form class="form" id="kt_form" action="{{url('/previousDesign/store')}}" method="post" enctype="multipart/form-data">
                                        @csrf

                                        <input type="number" class="d-none" name="product_id" value="{{$previousOrder->product->id ?? ''}}"/>
                                        <input type="text" class="d-none" name="label_picture"  value="{{$previousOrder->label_picture ?? ''}}"/>


                                        <!--begin::Wizard Step 3-->
                                        <div class="pb-5" data-wizard-type="step-content">
                                            <h4 class="mb-10 font-weight-bold text-dark">Choose Quantity</h4>
                                            <!--begin::Select-->

                                            <!--end::Input-->
                                            <div class="row mb-8 justify-content-around">
                                                <div class="col-lg-5 ">
                                                        ...
                                                        <div class="radio-list">
                                                            <table class="table text-center">
                                                                ...
                                                                @foreach($product->quantity as $qty)
                                                                    ...
                                                                    @else
                                                                        <tr>
                                                                            <td>
                                                                                <label class="radio">
                                                                                    <input type="radio" value="{{$qty->id}}" name="quantity"/>
                                                                                    <span></span>
                                                                                    {{$qty->quantity}}
                                                                                </label>
                                                                            </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" name="number_quantity" class="form-control"  placeholder="Quantity"/>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="headingOne4">
                                                        <div class="card-title" data-toggle="collapse" data-target="#collapseOne4">
                                                            <i class="flaticon2-copy"></i> Enter your Contact info
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="overflow-auto">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label>Phone</label>
                                                                            <input type="tel" class="form-control form-control-lg" name="tel" placeholder="Phone Number"  />
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-lg" name="zip_code" placeholder="Postcode"  />
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="headingTwo4">
                                                        <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo4">
                                                            <i class="flaticon2-layers-1 "></i> Choose from Your Contact
                                                        </div>
                                                    </div>
