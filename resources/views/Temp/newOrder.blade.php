                        ...
                        <div class="wizard wizard-1" id="kt_wizard_v1" data-wizard-state="step-first" data-wizard-clickable="false">
                                ...
                                <div class="wizard-steps p-8 p-lg-10">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-label">
                                            ...
                                            <h3 class="wizard-title">Order</h3>
                                        </div>
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12">
                                    ...
                                    <!--begin::Wizard Form-->
                                    <form class="form" id="kt_form" action="{{url('/orders/store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <!--begin::Wizard Step 2-->
                                            <input type="number" name="product_id" value="{{$product->id}}" class="d-none">
                                        <div class="" data-wizard-type="step-content">
                                            <h4 class="mb-10 font-weight-bold text-dark">Upload your label and choose quantity</h4>
                                            <!--begin::Input-->
